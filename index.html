...
<head>
    ...
    <!-- PAGE TITLE -->
    <title>CV - Ananda Putra Perdana</title>
    ...
    <div class="content-area">
        ...
        <div class="content-area-inner">
            ...
            <section id="intro">
                ...
                <div class="container-mid">
                    ...
                    <div class="animation-container animation-fade-down" data-animation-delay="0">
                        <h1>I’m Ananda Putra Perdana</h1>
                    </div>
                    <!-- /ANIMATION CONTAINER -->

                    <!-- ANIMATION CONTAINER -->
                    <div class="animation-container animation-fade-left" data-animation-delay="300">
                        <p class="subline">Hi, my full name is Ananda Putra Perdana. I am a junior design programmer and also a designer. in programmer I have skills as a front end developer while in design, I like to design a product and also make UI / UX appearance.</p>
                    </div>
                    <!-- /ANIMATION CONTAINER -->
            ...
            <section id="about">
                ...
                <p class="scroll-animated-from-right">With my abilities and knowledge, I believe I can complete the work given to me. I am very confident in my abilities and experience, that I believe I can help complete your work.</p>
                <p class="scroll-animated-from-right">Another reason I help is because I like to solve problems. the problem is an obstacle in my mind. if we can get past the obstacles then we are also one step ahead.</p>
            </section>
            <!-- /ABOUT -->
                ...
                <div class="showcase">
                    ...
                    <div class="item scroll-animated-from-right">
                        ...
                        <a href="#" data-featherlight="#item-1-lightbox">
                            ...
                            <!-- /INFO -->
                            <div class="background-image" style="background-image: url(assets/img/work/web.png)"></div>
                        </a>
                        <!-- /LIGHTBOX LINK -->
                        <!-- LIGHTBOX -->
                        <div id="item-1-lightbox" class="work-lightbox">
                            <img class="img-responsive" src="assets/img/work/web.png" alt="image">
                            <h3>Fashion Inc.</h3>
                    ...
                    <div class="item scroll-animated-from-right">
                        ...
                        <a href="#" data-featherlight="#item-2-lightbox">
                            ...
                            <!-- /INFO -->
                            <div class="background-image" style="background-image: url(assets/img/work/produk.jpg)"></div>
                        </a>
                        <!-- /LIGHTBOX LINK -->
                        ...
                        <div id="item-2-lightbox" class="work-lightbox">
                            <img class="img-responsive" src="assets/img/work/produk.jpg" alt="image">
                            <h3>Asimov 71</h3>
                    ...
                    <div class="item scroll-animated-from-right">
                        ...
                        <a href="#" data-featherlight="#item-4-lightbox">
                            ...
                            <!-- /INFO -->
                            <div class="background-image" style="background-image: url(assets/img/work/uiux.png)"></div>
                        </a>
                        <!-- /LIGHTBOX LINK -->
                        ...
                        <div id="item-4-lightbox" class="work-lightbox">
                            <img class="img-responsive" src="assets/img/work/uxui.png" alt="image">
                            <h3>Housing</h3>
            ...
            <section id="contact">
                ...
                <ul class="contact-list">
                    <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i>0895390061700</li>
                    <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i>anandaputraperdana5@mail.com</li>
                </ul>
                <!-- /CONTACT LIST -->
            ...
            <section id="footer">
                ...
                <ul class="social-icons scroll-animated-from-right">
                    <li><a href="https://web.facebook.com/memet.putra.5855/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="https://twitter.com/AnandaPutraPer3"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                    <li><a href="https://www.instagram.com/update.marketing_/?hl=en"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                </ul>
                <!-- /SOCIAL ICONS -->
                <p class="scroll-animated-from-right">© 2022 Curicullum Vitae | Design by Ananda Putra Perdana</a></p>
            </section>
            <!-- /FOOTER -->
        </div>
        <!-- /CONTENT AREA INNER -->
